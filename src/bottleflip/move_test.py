...
'''        right_limb.set_command_timeout(5)  
        #right_limb.set_joint_velocities({'e1':1.0, 'w1':2.0})
        #rospy.sleep(5)
        start_time = rospy.get_rostime().secs
        rate = rospy.Rate(100)
        while not rospy.is_shutdown():
          pub_rate.publish(100)
          right_limb.set_joint_velocities({'e1':5, 'w1':5, 's0':0, 's1':0, 'e0':0, 'w0':0, 'w2':0})
          rate.sleep()
...
print(rjoint_vels)
rjoint_vels['right_e0'] = 1.0
rjoint_vels['right_e1'] = 1.0
rjoint_vels['right_w1'] = 1.0
